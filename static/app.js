...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Spinner control: show/hide overlay while server/AI processes the image
  function showImageSpinner(show) {
  ...
  analyzeBtn.addEventListener('click', async () => {
    ...
    try {
      // Show spinner and prevent duplicate submissions while AI processes
      ...
      // Always hide spinner and re-enable controls after the request finishes
